...
const INITIAL_MITGLIEDSCHAFTEN: Mitgliedschaft[] = [
  { id: '1', kundeId: '1', typ: 'Premium', preis: 89, startdatum: '2024-01-15', enddatum: '2025-01-14', status: 'aktiv' },
  { id: '2', kundeId: '2', typ: 'Basic',   preis: 39, startdatum: '2024-03-20', enddatum: '2025-03-19', status: 'aktiv' },
  { id: '3', kundeId: '3', typ: 'Premium', preis: 89, startdatum: '2024-02-10', enddatum: '2025-02-09', status: 'aktiv' },
  { id: '4', kundeId: '4', typ: 'Basic',   preis: 39, startdatum: '2023-11-05', enddatum: '2024-11-04', status: 'gekuendigt' },
  { id: '5', kundeId: '5', typ: 'Basic',   preis: 39, startdatum: '2024-04-08', enddatum: '2025-04-07', status: 'aktiv' },
];
