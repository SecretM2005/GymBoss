...
const pill = StyleSheet.create({
  ...
  label: { fontSize: 10, fontWeight: '700', letterSpacing: 0.4, textTransform: 'uppercase', color: C.text },
  count: { fontFamily: FONT_MONO, fontSize: 11, fontWeight: '800', color: C.text },
});
